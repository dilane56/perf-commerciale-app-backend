...
@Schema(description = "Modification d'un objectif. Exactement un des deux titulaires (commercialId ou "
        + "managerId) doit etre renseigne.")
public record UpdateObjectifRequest(
